...
@section('content')
    ...
    <div class="box box-success">
        <div class="box-body">
            ...
            {!! csrf_field() !!}
            <div class="form-group col-md-4" id="div-type">
                <label>@lang('message.Type'):</label>
                <select name="type" id="type" class="type form-control">
                    <option value="">@lang('message.Select')</option>
                    <option value="">@lang('message.Band')</option>
                    <option value="">@lang('message.Artist')</option>
                    <option value="">@lang('message.Select')</option>
                </select>
            </div>
            ...
            <div class="form-group col-md-4" id="div-genre">
                <label>@lang('message.Genre'):</label>
                <select name="genre" id="genre" class="genre form-control">
                    <option value="">@lang('message.Select')</option>
